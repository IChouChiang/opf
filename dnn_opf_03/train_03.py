...
from config_03 import ModelConfig, TrainingConfig
...
def train_epoch(
    ...
    for batch_idx, batch in enumerate(pbar):
        ...
        if use_physics:
            ...
            # Loop over batch to handle potentially different topologies
